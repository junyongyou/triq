...
def setup(args):
    ...
    model = VisionTransformer(config, zero_head=True, num_classes=num_classes, load_transformer_weights=False)
...
def main():
    ...
    args['output_dir'] = r'C:\vq_datasets\results\ViT_hybrid_mGPUs'
    args['train_batch_size'] = 16
    args['eval_batch_size'] = 16
    args['eval_every'] = 4462
    args['learning_rate'] = 1e-4/2
    args['weight_decay'] = 0
    args['num_steps'] = 4462 * 120
    args['decay_type'] = 'cosine'
    args['warmup_steps'] = 4462 * 10
