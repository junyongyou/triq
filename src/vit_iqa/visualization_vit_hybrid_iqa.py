...
def load_model():
    ...
    model_checkpoint = r'C:\vq_datasets\results\ViT_hybrid_mGPUs\test0_checkpoint.bin'
...
# if __name__ == '__main__':
    ...
    result_image.save(r'.\database\attention_masks_vit_hybrid\{}_mask_vit_hybrid.png'.format(file_name))
